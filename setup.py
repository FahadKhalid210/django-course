#!/usr/bin/env python
"""
Package metadata for course_list.
"""
import os
import re
import sys
...
VERSION = get_version('course_list', '__init__.py')
...
setup(
    ...
    url='https://github.com/openedx/django_course',
    packages=find_packages(
        include=['course_list', 'course_list.*'],
        exclude=["*tests"],
    ),
    ...
    entry_points={
        "lms.djangoapp": [
            "course_list = course_list.apps:CourseListConfig",
        ],
    },
)
